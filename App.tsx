...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[100dvh] bg-black text-white font-mono overflow-hidden select-none">
        ...
        <div className="flex flex-col gap-1.5 sm:gap-4 w-full items-center">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 w-full max-w-md">
            <div className="flex-1 flex items-center bg-black/40 border border-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl overflow-hidden shadow-xl p-0.5 sm:p-1">
              ...
              <div className="relative flex-1 h-8 sm:h-12 overflow-hidden flex items-center justify-center">
                <div 
                  ...
                  style={{ transform: `translateX(calc(50% - ${fontIndex * 110 + 55}px))` }}
                >
                  {AVAILABLE_FONTS.map((font, idx) => (
                    <div 
                      key={font.name}
                      className={`flex-shrink-0 w-[110px] text-center transition-all duration-300 cursor-pointer ${idx === fontIndex ? 'scale-110 opacity-100' : 'scale-75 opacity-20'}`}
            ...
            <div className="relative group/size flex items-center">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 px-4 py-3 bg-black/90 backdrop-blur-xl rounded-2xl border border-white/10 opacity-0 invisible group-hover/size:opacity-100 group-hover/size:visible transition-all flex flex-col items-center gap-2 shadow-2xl min-w-[160px]">
            ...
            >
              <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-tr from-cyan-500/10 via-magenta-500/10 to-yellow-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-wrap justify-center">
            ...
            <div className="relative group/shadow flex items-center">
              <button 
                ...
                className={`flex items-center gap-1.5 sm:gap-2 border border-white/10 backdrop-blur-sm px-2.5 sm:px-4 py-1 sm:py-2 rounded-full shadow-md transition-all group ${shadowEnabled ? 'bg-white text-black' : 'bg-black/40 text-white'}`}
              >
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 px-4 py-3 bg-black/90 backdrop-blur-xl rounded-2xl border border-white/10 opacity-0 invisible group-hover/shadow:opacity-100 group-hover/shadow:visible transition-all flex flex-col items-center gap-2 shadow-2xl min-w-[160px]">
                <div className="w-full flex justify-between items-center">
            ...
            <div className="relative group/gap flex items-center">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 px-4 py-3 bg-black/90 backdrop-blur-xl rounded-2xl border border-white/10 opacity-0 invisible group-hover/gap:opacity-100 group-hover/gap:visible transition-all flex flex-col items-center gap-2 shadow-2xl min-w-[160px]">
                <div className="w-full flex justify-between items-center">
            ...
            <div className="relative group/duration flex items-center">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 px-4 py-3 bg-black/90 backdrop-blur-xl rounded-2xl border border-white/10 opacity-0 invisible group-hover/duration:opacity-100 group-hover/duration:visible transition-all flex flex-col items-center gap-2 shadow-2xl min-w-[160px]">
                <div className="w-full flex justify-between items-center">
      ...
      <div className="absolute inset-0 border-[8px] sm:border-[20px] border-black pointer-events-none z-40 opacity-50"></div>
